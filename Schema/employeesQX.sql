...
CREATE TABLE employee (
   ...
   PRIMARY KEY (EMPNO),
   CONSTRAINT fk_MGR FOREIGN KEY (MGR) REFERENCES employee (EMPNO)
      ON DELETE NO ACTION
	  ON UPDATE NO ACTION,
...
CREATE TABLE project (
   ...
   PRIMARY KEY (PROJID),
   CONSTRAINT fk_PROJ FOREIGN KEY (EMPNO) REFERENCES employee (EMPNO)
      ON DELETE NO ACTION
	  ON UPDATE CASCADE
);
-- GO
...
INSERT INTO project VALUES (7, 7782, '2005-06-22', '2005-06-25');
...
INSERT INTO project VALUES (14, 7839, '2005-06-29', '2005-06-30');
...
INSERT INTO project VALUES (12, 7934, '2005-06-27', '2005-06-28');
